...
describe('selectLoadingState', () => {
  ...
  it('should return error when error is present', async () => {
    store.setState({
      data: { items: [], loading: false, error: 'Network error' },
    });
  ...
  it('should return hasData: true when items array is non-empty', async () => {
    store.setState({
      data: { items: ['a', 'b'], loading: false, error: null },
    });
  ...
  it('should handle object data (non-array) with hasData: true when not null', async () => {
  ...
  it('should handle object data (non-array) with hasData: false when null', async () => {
  ...
  it('should support multiple loading selectors (OR logic)', async () => {
